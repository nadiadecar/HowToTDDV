...
func _process(delta):
	if (correcto.button_pressed and correcto_2.button_pressed and correcto_3.button_pressed and correcto_4.button_pressed and correcto_5.button_pressed) and not (incorrecto.button_pressed):
		siguiente.visible = true
	else:
		siguiente.hide()

func _on_siguiente_pressed():
	get_tree().change_scene_to_file("res://Escenas/Devlogs/DevlogNormal/DevlogNormal_2.tscn")
